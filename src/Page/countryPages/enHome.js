    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="title" content="【Discord List】Discord Server Bulletin Board｜You can find out right away if the call is active!" />
                ...
                <meta property="og:url" content="https://discordlist.kolysis.com/en" />
            </Helmet>
            <div></div>
        </>
    );
