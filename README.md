...
上記のCost Explorerの画像に示されている通り、プロジェクト全体の合計コストは$452.02となり、プロジェクト期間全体で均すと1か月あたりの平均コストは約$41.09でした。

詳細な内訳を見てみますと、主に開発および運用に注力していた2024年6月から11月にかけて、インフラストラクチャーの利用に伴う費用が顕著に増加しました。この期間が最もコストが高く、特に費用が嵩んだ月では$103にも達しました。これは、プロジェクトの進捗に伴い、必要なリソースを一時的に多く利用したためと考えられます。
